(function ( $ ) {
	var UROB_API_URL = "https://api.uptimerobot.com/";
	...
	function drawUptimeRobotHeader($setting, containerId){
		...
		uptimeRobotLogo.src = 'https://uptimerobot.com/assets/img/logo3.png';
	...
	function writeUptimeRobot($setting, xVal, yVal, containerId){
		...
		c.textAlign = 'center';
		c.lineWidth = 4;
		c.fillText("Uptime Robot (https://uptimerobot.com/)", xVal, yVal);	
	}
